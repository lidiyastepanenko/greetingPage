(function( $ ) {
  $.fn.sneg = function(options) {
    ...
    var settings = $.extend( {
      'col'				: 65,						//количество снежинок - чем больше значение, тем больше нагрузка.
      ...
      'v'				: 20,						//скорость падения снежинок 
      'colour'			: 'rgba(255,255,255,0.8)', 	//цвет снежинок любое rgb, rgba значение
